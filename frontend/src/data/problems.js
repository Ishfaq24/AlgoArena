...
print(maxArea([1,1]))  # Expected: 1`,
  ...
  "climbing-stairs": {
    ...
    description: {
      text: "You are climbing a staircase. It takes n steps to reach the top. Each time you can climb either 1 or 2 steps. Return the number of distinct ways you can climb to the top.",
      notes: ["The answer is guaranteed to fit in a 32-bit signed integer."],
    },
    examples: [
      {
        input: "n = 2",
...
class Solution {
  ...
  "word-search": {
    ...
    constraints: [
      ...
      "1 ≤ m, n ≤ 6",
      "1 ≤ word.length ≤ 15",
      "board[i][j] and word[k] consist of only uppercase and lowercase English letters",
    ],
    starterCode: {
