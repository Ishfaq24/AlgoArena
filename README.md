...
```bash
git clone https://github.com/yourusername/videoCallInterview.git
...
# Database
DB_URL=mongodb://localhost:27017/algotrena
...
2. **Clone** your fork:
   ```bash
   git clone https://github.com/YOUR_USERNAME/videoCallInterview.git
   ```
...
1. **Keep your fork updated**:
   ```bash
   git remote add upstream https://github.com/ishfaq24/videoCallInterview.git
   git fetch upstream
